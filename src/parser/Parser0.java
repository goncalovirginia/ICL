...
{if ("" != null) return new ASTIf(condition, ifBody, elseBody);}
  ...
  static final public ASTNode Function() throws ParseException {Token id, type = null;
...
params.add(id.image);
    ...
    jj_consume_token(RCBRA);
if (type != null) types.add(type.image);
        {if ("" != null) return new ASTFunction(params, types, body);}
    throw new Error("Missing return statement in function");
}

  static final public ASTNode FunctionCall(Token id) throws ParseException {List<ASTNode> args = new LinkedList<>();
        ASTNode arg;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case FN:
    case DEREF:
...
{if ("" != null) return new ASTFunctionCall(id.image, args);}
    throw new Error("Missing return statement in function");
}
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x80000000,0x0,0x40000000,0x100000,0x80000,0x70000,0x70000,0x3000000,0x3000000,0xc000000,0xc000000,0x12c0fa60,0x200000,0x80,0x100,0x12c0fa60,0x400,0x0,0x0,0x0,0x400000,0x0,0x12c0fa60,0x12c0fa60,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x0,0x0,0x2,0x0,0x10,0x8,0x10,0x0,0x20,0x2,0x2,};
	}
