/* ParserITokenManager.java */
/* Generated By:JavaCC: Do not edit this line. ParserITokenManager.java */
package base0;

/**
 * Token Manager.
 */
public class ParserITokenManager implements ParserIConstants {
	 ...
	 * Constructor.
	 */
	public ParserITokenManager(SimpleCharStream stream) {
	 ...
	 * Constructor.
	 */
	public ParserITokenManager(SimpleCharStream stream, int lexState) {
		ReInit(stream);
		SwitchTo(lexState);
	}
