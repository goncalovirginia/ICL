/* ParserCTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. ParserCTokenManager.java */
package base0;

/**
 * Token Manager.
 */
public class ParserCTokenManager implements ParserCConstants {
	 ...
	 * Constructor.
	 */
	public ParserCTokenManager(SimpleCharStream stream) {
	 ...
	 * Constructor.
	 */
	public ParserCTokenManager(SimpleCharStream stream, int lexState) {
		ReInit(stream);
		SwitchTo(lexState);
	}
